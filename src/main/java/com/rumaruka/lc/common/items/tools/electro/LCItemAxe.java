...
//
//public class LCItemAxe extends AxeItem implements ILETools {
//
//    private static final LEStorage storage =  LCStorageUtils.getTools();
//
//
//    public LCItemAxe(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
